...
class SimpleXLSXGen
{
    ...
    public function __construct()
    {
        $this->subject = '';
        $this->title = '';
        $this->author = 'Bill Webb <bill.webb@webbsatwork.com>';
        $this->company = 'Bill Webb <bill.webb@webbsatwork.com>';
        $this->manager = 'Bill Webb <bill.webb@webbsatwork.com>';
        $this->description = '';
        $this->keywords = '';
        $this->category = '';
        $this->lastModifiedBy = 'Bill Webb <bill.webb@webbsatwork.com>';
